...
- **Backup and disaster recovery** : The application relies on MongoDB Atlas's managed backup and restore capabilities, but the backup/restore and point-in-time recovery strategy is not documented in this repository.