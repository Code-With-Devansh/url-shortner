    ...
    >
      ...
      <div className="flex gap-2.5 flex-col sm:flex-row">
        <input
          ...
          className={`flex-1 bg-zinc-950 border rounded px-4 py-3.5 text-sm text-zinc-100 placeholder-zinc-600 outline-none focus:ring-2 transition-all duration-200 ${
            hasFieldError
      ...
      {error && (
        <p className="mt-2.5 text-xs text-red-400 tracking-wide">⚠ {error}</p>
      )}
    </form>
  );
};
